...
(function() {
    ...
    // ======== Adiciona o comando no menu principal ========
    ...
    // ======== Garante que o comando seja registrado ========
    ...
    Window_IngredientList.prototype.refresh = function() {
        ...
        const ingredients = [
            { id: 1, needed: 3 }, // ID 1 = Erva Verde
            { id: 2, needed: 5 }, // ID 2 = Cogumelo Vermelho
            { id: 3, needed: 2 }, // ID 3 = Peixe Azul
            { id: 4, needed: 4 }  // ID 4 = Pena de Corvo
        ];
        ...
        for (const ing of ingredients) {
            ...
            if (enough) {
                this.changeTextColor(this.textColor(24)); // verde
            } else {
